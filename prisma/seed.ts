...
async function main() {
  ...
  await prisma.factorModelVersion.upsert({ where: { modelKey_version: { modelKey: MODEL_V0.modelKey, version: MODEL_V0.version } }, update: { active: true, weights: MODEL_V0.factorWeights, configuration: MODEL_V0 }, create: { modelKey: MODEL_V0.modelKey, version: MODEL_V0.version, name: MODEL_V0.name, horizon: MODEL_V0.horizon, weights: MODEL_V0.factorWeights, configuration: MODEL_V0, active: true } });
